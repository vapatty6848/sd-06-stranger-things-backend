...
describe('Verifica se os scripts do package.json estão corretos', () => {
  it('Verifica se o comando `start` inicia o server com pm2 e se usa o ecosystem.', () => {
  ...
  it('Verifica se o comando `start:dev` inicia o server com pm2, se não usa o ecosystem e abre em watchMode.', () => {
